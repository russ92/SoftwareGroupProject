...
public class HashtagAnalysis {
    ...
    public static int location(String hashtag) {
        ...
        String[] place = { "USA", "America", "Europe", "Australia", "New Zealand", "Japan", "China", "Ireland",
                "Britain", "France", "Germany", "Spain", "Poland", "Sweeden", "Norway", "Denmark", "Canada", "EU",
                "Portugal", "Finland", "Russia", "Slovakia", "Estonia", "Latvia", "Slovenia", "Italy", "Switzerland",
                "Belgium", "Netherlands", "Austria", "Czech", "Africa", "South America", "Brazil", "Colombia",
                "Chile", "Mexico" };
