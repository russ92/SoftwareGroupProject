...
//    }
    ...
    public static String fileName(int rW) {
        int readOrWrite = rW;
        String name =
                "C:/Users/owenc/OneDrive/UCD Year 3 Sem 2/SWE Project/GROUP TEST/SoftwareGroupProject/swe-project/VaxData/Graphs"; // CHANGE THIS PATH AS NEEDED. MUST BE EXACT.
        if (readOrWrite == 1) {
            boolean exists = true;
            while (exists) {
